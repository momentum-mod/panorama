...
class ColorDisplay {
    static showPopup() {
        ...
        const popup = UiToolkitAPI.ShowCustomLayoutPopupParameters('', 'file://{resources}/layout/modals/popups/color-picker.xml', `color=${color}`);
    ...
    static updateDisplayOpacity() {
        ...
        $('#Display').style.backgroundImgOpacity = 1 - $.GetContextPanel().alpha;
    }
}
