...
class HudComparisons {
    ...
    static maxActiveSplits = 12;
    static newSplitTransitionDuration = 2;
    static panels = {
        splits: $('#Splits')
        // compare: $('#Compare')
    };
    ...
    static updateComparisons() {
        ...
        const data = hasCompare
            ? _.Run.Comparison.generateSplits(new _.Run.RunStats(currentStats, currentData.tickRate), new _.Run.RunStats(comparisonRun.compareRun.stats, currentData.tickRate)
            ...
            : new _.Run.RunStats(currentStats, currentData.tickRate, this.runStatsZoneIndex + 1).zones[this.runStatsZoneIndex];
        ...
        Object.assign(panel, hasCompare
            ? {
                name: data.name,
