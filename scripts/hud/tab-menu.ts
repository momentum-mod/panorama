...
class HudTabMenuHandler {
	...
	showZoneMenu() {
		...
		this.panels.zoningOpen.AddClass('hud-tab-menu__zoning--hidden');
		this.panels.zoningClose.RemoveClass('hud-tab-menu__zoning--hidden');
	}
	...
	hideZoneMenu() {
		...
		this.panels.zoningContainer.AddClass('hud-tab-menu__zoning--hidden');
		this.panels.zoningOpen.RemoveClass('hud-tab-menu__zoning--hidden');
		this.panels.zoningClose.AddClass('hud-tab-menu__zoning--hidden');
	}
