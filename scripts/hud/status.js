class HudStatus {
	...
	static updateLabel() {
		if (this.USENEWTIMER) {
			const timerStatus = MomentumTimerAPI.GetTimerStatus();
	...
	static {
		...
		$.RegisterForUnhandledEvent('ChaosLevelInitPostEntity', this.onLevelInit.bind(this));
		$.RegisterForUnhandledEvent('OnObservedTimerStateChange', this.onTimerStatusChanged.bind(this));
		$.RegisterForUnhandledEvent('OnObservedTimerCheckpointChange', this.onTimerStatusChanged.bind(this));
