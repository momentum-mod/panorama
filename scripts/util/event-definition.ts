...
declare interface GlobalEventNameMap {
	...
	HideMainMenuContentPanel: () => void;

	ShowMainMenuContentPanel: () => void;
	...
	SettingsNavigateToPanel: (tabID: string, panel: GenericPanel) => void;
	...
	Drawer_NavigateToTab: (tabID: number) => void;

	/** Open drawer if closed, and switch the tab to the specified tab */
	Drawer_ExtendAndNavigateToTab: (tabID: number) => void;
