...
declare interface MomHudSnap extends AbstractHudPanel<'MomHudSnap'> {}
UiToolkitAPI.RegisterHUDPanel2d('MomHudSnap', 'file://{resources}/layout/hud/snap.xml');
