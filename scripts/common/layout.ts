 ...
 *
 * Sasha: changed all generics to extend from GenericPanel instead of Panel
 */

export type Size = [number, number];
export type Position = [number, number];

export function getPositionAndSize<P extends GenericPanel>(panel: P): [Position, Size] {
	return [
...
export function setPositionAndSize<P extends GenericPanel>(panel: P, [x, y]: Position, [width, height]: Size): P {
...
export function copyPositionAndSize<P1 extends GenericPanel, P2 extends GenericPanel>(
	sourcePanel: P1,
	targetPanel: P2
): P2 {
...
export function getPosition<P extends GenericPanel>(panel: P): Position {
	return [panel.actualxoffset / panel.actualuiscale_x, panel.actualyoffset / panel.actualuiscale_y];
}

export function setPosition<P extends GenericPanel>(panel: P, [x, y]: Position): P {
	panel.style.position = `${x}px ${y}px 0px`;
	return panel;
}

export function copyPosition<P1 extends GenericPanel, P2 extends GenericPanel>(sourcePanel: P1, targetPanel: P2): P2 {
...
export function getSize<P extends GenericPanel>(panel: P): Size {
	return [panel.actuallayoutwidth / panel.actualuiscale_x, panel.actuallayoutheight / panel.actualuiscale_y];
}

export function setSize<P extends GenericPanel>(panel: P, [width, height]: Position): P {
	Object.assign(panel.style, {
		width: `${width}px`,
		height: `${height}px`
	});
...
export function copySize<P1 extends GenericPanel, P2 extends GenericPanel>(sourcePanel: P1, targetPanel: P2): P2 {
...
export function copyWidth<P1 extends GenericPanel, P2 extends GenericPanel>(sourcePanel: P1, targetPanel: P2): P2 {
...
export function copyHeight<P1 extends GenericPanel, P2 extends GenericPanel>(sourcePanel: P1, targetPanel: P2): P2 {
